...
const genSubject = ({ userName }) => `哈囉 ${userName}，我們想邀請你填寫網站優化意見調查！`;

const genBodyHTML = ({ userName, surveryUrl }) => {
                              ...
                              <tr class="container__row">
                                <td class="container__cell" width="100%" align="left" valign="top" style="padding-left: 16px; padding-right: 16px; padding-bottom: 16px;">
                                  <p class="center text p" style="color: #000000; margin: 0; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; line-height: 1.5; width: 100%; display: block; text-align: center; margin-left: auto; margin-right: auto;">
                                    <a href="https://www.goodjob.life?utm_source=goodjob&utm_medium=email&utm_campaign=survey" class="a" style="font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: none;"><span class="a__text" style="text-decoration: none;"><img src="https://image.goodjob.life/logo_570x70.png" width="285" height="35" alt="goodjob 職場透明化運動" border="0" class="img__block" style="display: block; max-width: 100%; margin-right: auto; margin-left: auto;" /></span></a>
                                  </p>
                                </td>
                              </tr>
                            </table> <!--[if mso | IE]> </td>
                                        ...
                                        <td> <![endif]--> <table class="block__table" role="presentation" border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                                            <tr class="block__row">
                                              <td class="block__cell" width="100%" align="left" valign="top" style="background-color: #FFFFFF; border-radius: 4px; padding: 32px 40px;" bgcolor="#FFFFFF">
                                                <!-- start h1 -->
                                                <h1 class="heading-m header h1" style="color: #000000; margin: 0; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; line-height: 1.4; font-size: 28px; font-weight: 700;">網站優化意見調查</h1>
                                                <!-- end h1 -->
                                                <!-- start content -->
                                                <div class="row">
                                                  <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                                    <tr class="row__row">
                                                      ...
                                                      <p>哈囉, ${escapeHtml(userName)}！</p>
                                                      <p><a href="https://www.goodjob.life?utm_source=goodjob&utm_medium=email&utm_campaign=survey">GoodJob 職場透明化運動</a> 從 2016 年創站至今，已經有超過萬名的勞工朋友，分享超過 1 萬 7 千筆的薪資工時、面試心得，以及工作心得資訊，每週幫助超過一萬名求職者，尋找更好的工作！</p>
                                                      <p>接下來，我們想做的更好。</p>
                                                      <p>我們希望蒐集你的回饋，並邀請你進行深度訪談，讓我們更瞭解你找工作時所遇到的困難，作為網站優化改版的依據。</p>
                                                      <p>你的回饋，將會是我們進步最重要的動力！而填寫問卷僅需 3 分鐘！</p>
                                                        <div class="row">
                                                          <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                                            <tr class="row__row">
                                                              ...
                                                              <table border="0" cellspacing="0" cellpadding="0" class="table" style="border-collapse: collapse;">
                                                                <tr class="tr">
                                                                  <td align="center" bgcolor="#fcd406;" class="td" style="border-collapse: collapse;">
                                                                    <a href="${escapeHtml(surveryUrl)}" class="button-m a" style="font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; text-decoration: none; padding: 10px 24px; font-weight: 700; background-color: #FCD406; color: #000000; display: inline-block;"><span class="a__text" style="text-decoration: none; color: #000000;">馬上填寫問卷</span></a>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </td>
                              ...
                              <tr class="container__row">
                                <td class="container__cell" width="100%" align="left" valign="top" style="padding-left: 16px; padding-right: 16px; padding-bottom: 16px; padding-top: 16px;">
                                  <p class="footer text p" style="display: block; margin: 0; font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; line-height: 1.5; color: #999999; font-size: 14px; text-align: center;">
                                    <span>© GoodJob.life team</span>&nbsp;&nbsp;<a href="https://www.goodjob.life?utm_source=goodjob&utm_medium=email&utm_campaign=survey" class="a" style="font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; color: #999999; text-decoration: none;"><span class="a__text" style="color: #999999; text-decoration: none;">官方網站</span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="https://www.facebook.com/goodjob.life" class="a" style="font-family: 'PingFang TC','微軟正黑體','Microsoft JhengHei','Helvetica Neue',Helvetica,Arial,sans-serif; color: #999999; text-decoration: none;"><span class="a__text" style="color: #999999; text-decoration: none;">facebook</span></a>
                                  </p>
                                </td>
                              </tr>
                            </table> <!--[if mso | IE]> </td>
